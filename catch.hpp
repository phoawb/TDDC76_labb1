...
////////////////////////////////////////////////////////////////////////////////////////////////////
// start catch_reporter_komplettering.cpp
#include <cfloat>
#include <cstdio>
...
namespace Catch {
    ...
    struct InfoReporter : StreamingReporterBase<InfoReporter> {
      //TablePrinter m_tablePrinter;

        InfoReporter( ReporterConfig const& config )
        :   StreamingReporterBase(config )
        {}

        ~InfoReporter() override;
        static std::string getDescription() {
            return "Reports the info associated with a test-fail. In order to print custom messages associated with the failures.";
        }
	  ...
	  /*void printResultType() const {
            ...
            void printMessage() const {
                ...
                for( auto const& msg : messages ) {
                    // If this assertion is a warning ignore any INFO messages
                    if( printInfoMessages || msg.type != ResultWas::Info )
                        stream << Column( msg.message ).indent(0) << '\n';
                }
    ...
    CATCH_REGISTER_REPORTER( "info", InfoReporter )
...
// end catch_reporter_komplettering.cc
////////////////////////////////////////////////////////////////////////////////////////////////////
